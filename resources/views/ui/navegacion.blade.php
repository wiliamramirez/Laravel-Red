<a href=" {{ route("recetas.create") }} " class="btn btn-outline-secondary mr-2 text-uppercase font-weight-bold">
...
{{--  <a href=" {{ route("perfiles.edit", [ "perfil" => $usuario->id ])}} " class="btn btn-outline-primary mr-2
